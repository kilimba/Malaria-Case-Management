...
@RestController(value = "Tracking.DepartmentController")
@Api(value = "/tracking/Department", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/tracking/Department")
public class DepartmentController {
    ...
    public Department editDepartment(@PathVariable("id") Integer id, @RequestBody Department instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Department with id: {}" , instance.getId());
        instance.setId(id);
