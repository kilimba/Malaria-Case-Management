...
@Api(description = "Exposes APIs to work with Village resource.", value = "VillageController")
public class VillageController {
    ...
    @RequestMapping(value = "/{id:.+}/bloodSlides", method = RequestMethod.GET)
    @ApiOperation(value = "Gets the bloodSlides instance associated with the given id.")
    public Page<BloodSlide> findAssociatedbloodSlides(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated bloodSlides");
        return bloodSlideService.findAssociatedValues(id, "village", "villageId", pageable);
    }
