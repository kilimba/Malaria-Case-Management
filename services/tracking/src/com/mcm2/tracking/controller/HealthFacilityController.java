...
@Api(description = "Exposes APIs to work with HealthFacility resource.", value = "HealthFacilityController")
public class HealthFacilityController {
    ...
    @RequestMapping(value = "/{id:.+}/healthworkers", method = RequestMethod.GET)
    @ApiOperation(value = "Gets the healthworkers instance associated with the given id.")
    public Page<Healthworker> findAssociatedhealthworkers(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated healthworkers");
        return healthworkerService.findAssociatedValues(id, "healthFacility", "id", pageable);
    }
