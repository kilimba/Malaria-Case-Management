...
@Service
public class TrackingQueryExecutorServiceImpl implements TrackingQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TrackingQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("trackingWMQueryExecutor")
